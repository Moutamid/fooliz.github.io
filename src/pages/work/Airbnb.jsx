...
export default function Imgtogether() {
  ...
  return (
    <div className="w-full h-screen overflow-auto relative">
      ...
      <img
        src="https://firebasestorage.googleapis.com/v0/b/foolee-inc.appspot.com/o/fooliz.-website-assets%2Flong-screenshots%2FAirbnb.png?alt=media&token=4c4bb766-b0a0-443f-a23c-dd6af3fc7262"
        alt="Talk Image"
        className="hidden"
        onLoad={() => {
          setImageLoaded(true);
