...
export default function Imgtogether() {
  ...
  return (
    <div className="w-full h-screen overflow-auto relative">
      ...
      <img
        src="https://firebasestorage.googleapis.com/v0/b/foolee-inc.appspot.com/o/fooliz.-website-assets%2Flong-screenshots%2FTubeKing.png?alt=media&token=f05269bb-5914-49b9-8b73-c72e7caada19"
        alt="Talk Image"
        className="hidden"
        onLoad={() => {
          setImageLoaded(true);
