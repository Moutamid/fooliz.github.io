...
export default function Imgtogether() {
  ...
  return (
    <div className="w-full h-screen overflow-auto relative">
      ...
      <img
        src="https://firebasestorage.googleapis.com/v0/b/foolee-inc.appspot.com/o/fooliz.-website-assets%2Flong-screenshots%2FRoutineApp.png?alt=media&token=e397e2ce-51ae-4cb4-b634-070e342ecaab"
        alt="Talk Image"
        className="hidden"
        onLoad={() => {
          setImageLoaded(true);
